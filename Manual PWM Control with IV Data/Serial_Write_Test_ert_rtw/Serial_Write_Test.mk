###########################################################################
## Makefile generated for component 'Serial_Write_Test'. 
## 
## Makefile     : Serial_Write_Test.mk
## Generated on : Thu Jul 07 13:50:30 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Serial_Write_Test.out
...
PRODUCT_NAME              = Serial_Write_Test
MAKEFILE                  = Serial_Write_Test.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Serial_Write_Test.out
...
DEFINES_STANDARD = -DMODEL=Serial_Write_Test -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/Serial_Write_Test_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Serial_Write_Test_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Serial_Write_Test_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Serial_Write_Test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/Serial_Write_Test_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/Serial_Write_Test_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


DSP28xx_SciUtil.obj : $(START_DIR)/Serial_Write_Test_ert_rtw/DSP28xx_SciUtil.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


Serial_Write_Test.obj : $(START_DIR)/Serial_Write_Test_ert_rtw/Serial_Write_Test.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


Serial_Write_Test_data.obj : $(START_DIR)/Serial_Write_Test_ert_rtw/Serial_Write_Test_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/Serial_Write_Test_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
