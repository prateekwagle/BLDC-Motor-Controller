###########################################################################
## Makefile generated for component 'pwm_with_data_2'. 
## 
## Makefile     : pwm_with_data_2.mk
## Generated on : Wed Jul 06 14:40:04 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/pwm_with_data_2.out
...
PRODUCT_NAME              = pwm_with_data_2
MAKEFILE                  = pwm_with_data_2.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/EEEDST~1/DOCUME~1/BLDC-M~1/MANUAL~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = TI C28x
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/pwm_with_data_2.out
...
DEFINES_SKIPFORSIL = -DDAEMON_MODE=1 -DXCP_CUSTOM_PLATFORM -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DMW_PIL_SCIFIFOLEN=16 -DF2837X_REG_FORMAT -DMW_F2837XD -DSTACK_SIZE=1024 -DRT -DF28379D -DCPU1 -DBOOT_FROM_FLASH=1 -DCPU_RAMLS_PROG_START=0x8000 -DCPU_RAMLS_PROG_LENGTH=0x1800 -DCLA_RAMLS_PROG_START=0xA800 -DCLA_RAMLS_PROG_LENGTH=0x800 -DCLA_RAMLS_DATA_START=0x9800 -DCLA_RAMLS_DATA_LENGTH=0x1000
DEFINES_STANDARD = -DMODEL=pwm_with_data_2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_c28xx_csl.obj MW_c28xx_board.obj MW_c28xx_xbar.obj MW_c28xx_adc.obj MW_c28xx_pwm.obj pwm_with_data_2.obj pwm_with_data_2_data.obj sysctl.obj c2837xDBoard_Realtime_Support.obj MW_c28xGlobalInterrupts.obj dma.obj F2837xD_CpuTimers.obj F2837xD_DefaultISR.obj F2837xD_GlobalVariableDefs.obj F2837xD_PieCtrl.obj F2837xD_PieVect.obj F2837xD_SysCtrl.obj F2837xD_usDelay.obj F2837xD_CodeStartBranch.obj F2837xD_Dma.obj F2837xD_Adc.obj F2837xD_Gpio.obj F2837xD_Ipc_Driver_Lite.obj c2000HardwareTimerConfig.obj MW_c28xGPIO.obj c2837xDSchedulerTimer0.obj ext_svr_c2000.obj updown_c2000.obj ext_work_c2000.obj rtiostream_utils_c2000.obj rtiostream_interface_c2000.obj rtiostream_serial_c28x_ext.obj datamodify.obj daemon_checksum.obj
...
%.obj : $(START_DIR)/pwm_with_data_2_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/pwm_with_data_2_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/pwm_with_data_2_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/pwm_with_data_2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/pwm_with_data_2_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/pwm_with_data_2_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_xbar.obj : $(START_DIR)/pwm_with_data_2_ert_rtw/MW_c28xx_xbar.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_adc.obj : $(START_DIR)/pwm_with_data_2_ert_rtw/MW_c28xx_adc.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_pwm.obj : $(START_DIR)/pwm_with_data_2_ert_rtw/MW_c28xx_pwm.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/pwm_with_data_2_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


pwm_with_data_2.obj : $(START_DIR)/pwm_with_data_2_ert_rtw/pwm_with_data_2.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


pwm_with_data_2_data.obj : $(START_DIR)/pwm_with_data_2_ert_rtw/pwm_with_data_2_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
...
ext_work_c2000.obj : C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/tic2000/src/ext_work_c2000.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtiostream_utils_c2000.obj : C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/tic2000/src/rtiostream_utils_c2000.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtiostream_interface_c2000.obj : C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/tic2000/src/rtiostream_interface_c2000.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
...
daemon_checksum.obj : C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/shared/externalmode_daemon/src/daemon_checksum.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
