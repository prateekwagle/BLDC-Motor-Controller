...
#include "rtwtypes.h"
#include "pwm_with_data_2_dt.h"

/* Block signals (default storage) */
B_pwm_with_data_2_T pwm_with_data_2_B;

/* Block states (default storage) */
DW_pwm_with_data_2_T pwm_with_data_2_DW;

/* Real-time model */
static RT_MODEL_pwm_with_data_2_T pwm_with_data_2_M_;
RT_MODEL_pwm_with_data_2_T *const pwm_with_data_2_M = &pwm_with_data_2_M_;
...
void isr_int1pie1_task_fcn(void)
{
  if (1 == runModel) {
    /* Call the system: <Root>/Function-Call Subsystem */
    {
      ...
      srClearBC(pwm_with_data_2_DW.FunctionCallSubsystem_SubsysRan);
       ...
       */
      pwm_with_data_2_M->Timing.clockTick1 =
        pwm_with_data_2_M->Timing.rtmL2HDbBufClockTick
        [pwm_with_data_2_M->Timing.rtmL2HLastBufWr];

      /* S-Function (c2802xadc): '<S1>/ADC2' */
      {
        /*  Internal Reference Voltage : Fixed scale 0 to 3.3 V range.  */
        /*  External Reference Voltage : Allowable ranges of VREFHI(ADCINA0) = 3.3 and VREFLO(tied to ground) = 0  */
        pwm_with_data_2_B.ADC2 = (AdcaResultRegs.ADCRESULT0);
      }
      ...
      {
        EPwm4Regs.CMPA.bit.CMPA = (uint16_T)(pwm_with_data_2_DW.A);
      }
      ...
      {
        EPwm5Regs.CMPA.bit.CMPA = (uint16_T)(pwm_with_data_2_DW.B);
      }
      ...
      {
        EPwm6Regs.CMPA.bit.CMPA = (uint16_T)(pwm_with_data_2_DW.C);
      }
       ...
       */
      {
        GpioDataRegs.GPBTOGGLE.bit.GPIO52 = (pwm_with_data_2_P.EnableGate_Value
          != 0);
      }

      pwm_with_data_2_DW.FunctionCallSubsystem_SubsysRan = 4;
...
/* Model step function */
void pwm_with_data_2_step(void)
{
  /* DataStoreWrite: '<Root>/Data Store Write' incorporates:
   *  Constant: '<Root>/Constant'
   */
  pwm_with_data_2_DW.A = pwm_with_data_2_P.Constant_Value;

  /* DataStoreWrite: '<Root>/Data Store Write1' incorporates:
   *  Constant: '<Root>/Constant1'
   */
  pwm_with_data_2_DW.B = pwm_with_data_2_P.Constant1_Value;

  /* DataStoreWrite: '<Root>/Data Store Write2' incorporates:
   *  Constant: '<Root>/Constant2'
   */
  pwm_with_data_2_DW.C = pwm_with_data_2_P.Constant2_Value;

  /* DataStoreRead: '<Root>/Data Store Read1' */
  pwm_with_data_2_B.DataStoreRead1 = pwm_with_data_2_DW.E;

  /* DataStoreRead: '<Root>/Data Store Read2' */
  pwm_with_data_2_B.DataStoreRead2 = pwm_with_data_2_DW.D;

  /* DataStoreRead: '<Root>/Data Store Read3' */
  pwm_with_data_2_B.DataStoreRead3 = pwm_with_data_2_DW.F;

  /* S-Function (c280xgpio_do): '<Root>/Digital Output' incorporates:
   *  Constant: '<Root>/Enable Gate'
   */
  {
    if (pwm_with_data_2_P.EnableGate_Value_f)
   ...
   */
  {
    if (pwm_with_data_2_P.Wake_Value)
  ...
  {                                    /* Sample time: [0.2s, 0.0s] */
    rtExtModeUpload(0, (real_T)pwm_with_data_2_M->Timing.taskTime0);
  }

  /* signal main to stop simulation */
  {                                    /* Sample time: [0.2s, 0.0s] */
    if ((rtmGetTFinal(pwm_with_data_2_M)!=-1) &&
        !((rtmGetTFinal(pwm_with_data_2_M)-pwm_with_data_2_M->Timing.taskTime0) >
          pwm_with_data_2_M->Timing.taskTime0 * (DBL_EPSILON))) {
      rtmSetErrorStatus(pwm_with_data_2_M, "Simulation finished");
    }

    if (rtmGetStopRequested(pwm_with_data_2_M)) {
      rtmSetErrorStatus(pwm_with_data_2_M, "Simulation finished");
    }
  }
   ...
   */
  pwm_with_data_2_M->Timing.taskTime0 =
    ((time_T)(++pwm_with_data_2_M->Timing.clockTick0)) *
    pwm_with_data_2_M->Timing.stepSize0;

  {
    /* Base rate updates double buffers of absolute time for
       ...
       -- rtmL2HLastBufWr is the buffer index that is written last.
     */
    boolean_T bufIdx = !(pwm_with_data_2_M->Timing.rtmL2HLastBufWr != 0U);
    pwm_with_data_2_M->Timing.rtmL2HDbBufClockTick[bufIdx] =
      pwm_with_data_2_M->Timing.clockTick0;
    pwm_with_data_2_M->Timing.rtmL2HLastBufWr = bufIdx ? 1U : 0U;
  }
}

/* Model initialize function */
void pwm_with_data_2_initialize(void)
{
  /* Registration code */

  /* initialize real-time model */
  (void) memset((void *)pwm_with_data_2_M, 0,
                sizeof(RT_MODEL_pwm_with_data_2_T));
  rtmSetTFinal(pwm_with_data_2_M, -1);
  pwm_with_data_2_M->Timing.stepSize0 = 0.2;

  /* External mode info */
  pwm_with_data_2_M->Sizes.checksums[0] = (1214626430U);
  pwm_with_data_2_M->Sizes.checksums[1] = (1955497182U);
  pwm_with_data_2_M->Sizes.checksums[2] = (3027943112U);
  pwm_with_data_2_M->Sizes.checksums[3] = (2381813459U);

  {
    static const sysRanDType rtAlwaysEnabled = SUBSYS_RAN_BC_ENABLE;
    static RTWExtModeInfo rt_ExtModeInfo;
    static const sysRanDType *systemRan[2];
    pwm_with_data_2_M->extModeInfo = (&rt_ExtModeInfo);
    rteiSetSubSystemActiveVectorAddresses(&rt_ExtModeInfo, systemRan);
    systemRan[0] = &rtAlwaysEnabled;
    systemRan[1] = (sysRanDType *)
      &pwm_with_data_2_DW.FunctionCallSubsystem_SubsysRan;
    rteiSetModelMappingInfoPtr(pwm_with_data_2_M->extModeInfo,
      &pwm_with_data_2_M->SpecialInfo.mappingInfo);
    rteiSetChecksumsPtr(pwm_with_data_2_M->extModeInfo,
                        pwm_with_data_2_M->Sizes.checksums);
    rteiSetTPtr(pwm_with_data_2_M->extModeInfo, rtmGetTPtr(pwm_with_data_2_M));
  }

  /* block I/O */
  (void) memset(((void *) &pwm_with_data_2_B), 0,
                sizeof(B_pwm_with_data_2_T));

  /* states (dwork) */
  (void) memset((void *)&pwm_with_data_2_DW, 0,
                sizeof(DW_pwm_with_data_2_T));
  ...
  /* data type transition information */
  {
    ...
    (void) memset((char_T *) &dtInfo, 0,
                  sizeof(dtInfo));
    pwm_with_data_2_M->SpecialInfo.mappingInfo = (&dtInfo);
  ...
  pwm_with_data_2_DW.A = pwm_with_data_2_P.DataStoreMemory_InitialValue;

  /* Start for DataStoreMemory: '<Root>/Data Store Memory1' */
  pwm_with_data_2_DW.B = pwm_with_data_2_P.DataStoreMemory1_InitialValue;

  /* Start for DataStoreMemory: '<Root>/Data Store Memory2' */
  pwm_with_data_2_DW.C = pwm_with_data_2_P.DataStoreMemory2_InitialValue;

  /* Start for DataStoreMemory: '<Root>/Data Store Memory3' */
  pwm_with_data_2_DW.D = pwm_with_data_2_P.DataStoreMemory3_InitialValue;

  /* Start for DataStoreMemory: '<Root>/Data Store Memory4' */
  pwm_with_data_2_DW.E = pwm_with_data_2_P.DataStoreMemory4_InitialValue;

  /* Start for DataStoreMemory: '<Root>/Data Store Memory5' */
  pwm_with_data_2_DW.F = pwm_with_data_2_P.DataStoreMemory5_InitialValue;
...
void pwm_with_data_2_terminate(void)
{
