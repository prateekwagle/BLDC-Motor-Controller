...
#ifndef RTW_HEADER_pwm_with_data_h_
#define RTW_HEADER_pwm_with_data_h_
#ifndef pwm_with_data_COMMON_INCLUDES_
#define pwm_with_data_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "IQmathLib.h"
#endif                                 /* pwm_with_data_COMMON_INCLUDES_ */

#include "pwm_with_data_types.h"
#include <string.h>
...
typedef struct {
  ...
  uint16_T ADC_VSENB;                  /* '<S1>/ADC_VSENB' */
} B_pwm_with_data_T;
...
struct tag_RTM_pwm_with_data_T {
...
extern P_pwm_with_data_T pwm_with_data_P;

/* Block signals (default storage) */
extern B_pwm_with_data_T pwm_with_data_B;

/* Block states (default storage) */
extern DW_pwm_with_data_T pwm_with_data_DW;

/* Model entry point functions */
extern void pwm_with_data_initialize(void);
extern void pwm_with_data_step(void);
extern void pwm_with_data_terminate(void);
extern volatile boolean_T runModel;

/* Real-time Model object */
extern RT_MODEL_pwm_with_data_T *const pwm_with_data_M;
 ...
 *
 * '<Root>' : 'pwm_with_data'
 * '<S1>'   : 'pwm_with_data/Function-Call Subsystem'
 */
#endif                                 /* RTW_HEADER_pwm_with_data_h_ */
