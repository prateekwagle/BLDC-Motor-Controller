...
B_pwm_with_data_T pwm_with_data_B;

/* Block states (default storage) */
DW_pwm_with_data_T pwm_with_data_DW;

/* Real-time model */
static RT_MODEL_pwm_with_data_T pwm_with_data_M_;
RT_MODEL_pwm_with_data_T *const pwm_with_data_M = &pwm_with_data_M_;
...
void isr_int1pie1_task_fcn(void)
{
  if (1 == runModel) {
    /* Call the system: <Root>/Function-Call Subsystem */
    {
      ...
      srClearBC(pwm_with_data_DW.FunctionCallSubsystem_SubsysRan);
       ...
       */
      pwm_with_data_M->Timing.clockTick1 =
        pwm_with_data_M->Timing.rtmL2HDbBufClockTick
        [pwm_with_data_M->Timing.rtmL2HLastBufWr];

      /* S-Function (c2802xadc): '<S1>/ADC_VSENB' */
      {
        /*  Internal Reference Voltage : Fixed scale 0 to 3.3 V range.  */
        /*  External Reference Voltage : Allowable ranges of VREFHI(ADCINA0) = 3.3 and VREFLO(tied to ground) = 0  */
        pwm_with_data_B.ADC_VSENB = (AdccResultRegs.ADCRESULT0);
      }
      ...
      {
        EPwm4Regs.CMPA.bit.CMPA = (uint16_T)(pwm_with_data_DW.A);
      }
      ...
      {
        EPwm5Regs.CMPA.bit.CMPA = (uint16_T)(pwm_with_data_DW.B);
      }
      ...
      {
        EPwm6Regs.CMPA.bit.CMPA = (uint16_T)(pwm_with_data_DW.C);
      }
       ...
       */
      {
        GpioDataRegs.GPBTOGGLE.bit.GPIO52 = (pwm_with_data_P.EnableGate_Value !=
          0);
      }

      pwm_with_data_DW.FunctionCallSubsystem_SubsysRan = 4;

      /* End of Outputs for S-Function (c28xisr_c2000): '<Root>/C28x Hardware Interrupt' */
    }

    currentTime = (extmodeSimulationTime_T) pwm_with_data_M->Timing.clockTick0;
    extmodeEvent(1,currentTime);
  }
}

/* Model step function */
void pwm_with_data_step(void)
{
  /* DataStoreWrite: '<Root>/Data Store Write' incorporates:
   *  Constant: '<Root>/Constant'
   */
  pwm_with_data_DW.A = pwm_with_data_P.Constant_Value;

  /* DataStoreWrite: '<Root>/Data Store Write1' incorporates:
   *  Constant: '<Root>/Constant1'
   */
  pwm_with_data_DW.B = pwm_with_data_P.Constant1_Value;

  /* DataStoreWrite: '<Root>/Data Store Write2' incorporates:
   *  Constant: '<Root>/Constant2'
   */
  pwm_with_data_DW.C = pwm_with_data_P.Constant2_Value;

  /* DataStoreRead: '<Root>/Data Store Read1' */
  pwm_with_data_B.DataStoreRead1 = pwm_with_data_DW.E;

  /* DataStoreRead: '<Root>/Data Store Read2' */
  pwm_with_data_B.DataStoreRead2 = pwm_with_data_DW.D;

  /* DataStoreRead: '<Root>/Data Store Read3' */
  pwm_with_data_B.DataStoreRead3 = pwm_with_data_DW.F;

  /* S-Function (c280xgpio_do): '<Root>/Digital Output' incorporates:
   *  Constant: '<Root>/Enable Gate'
   */
  {
    if (pwm_with_data_P.EnableGate_Value_f)
   ...
   */
  pwm_with_data_M->Timing.taskTime0 =
    ((time_T)(++pwm_with_data_M->Timing.clockTick0)) *
    pwm_with_data_M->Timing.stepSize0;

  {
    /* Base rate updates double buffers of absolute time for
       ...
       -- rtmL2HLastBufWr is the buffer index that is written last.
     */
    boolean_T bufIdx = !(pwm_with_data_M->Timing.rtmL2HLastBufWr != 0U);
    pwm_with_data_M->Timing.rtmL2HDbBufClockTick[bufIdx] =
      pwm_with_data_M->Timing.clockTick0;
    pwm_with_data_M->Timing.rtmL2HLastBufWr = bufIdx ? 1U : 0U;
  }
}

/* Model initialize function */
void pwm_with_data_initialize(void)
{
  /* Registration code */

  /* initialize real-time model */
  (void) memset((void *)pwm_with_data_M, 0,
                sizeof(RT_MODEL_pwm_with_data_T));
  rtmSetTFinal(pwm_with_data_M, -1);
  pwm_with_data_M->Timing.stepSize0 = 0.001;

  /* External mode info */
  pwm_with_data_M->Sizes.checksums[0] = (2553616457U);
  pwm_with_data_M->Sizes.checksums[1] = (2642130602U);
  pwm_with_data_M->Sizes.checksums[2] = (633936111U);
  pwm_with_data_M->Sizes.checksums[3] = (2212310136U);

  {
    static const sysRanDType rtAlwaysEnabled = SUBSYS_RAN_BC_ENABLE;
    static RTWExtModeInfo rt_ExtModeInfo;
    static const sysRanDType *systemRan[2];
    pwm_with_data_M->extModeInfo = (&rt_ExtModeInfo);
    rteiSetSubSystemActiveVectorAddresses(&rt_ExtModeInfo, systemRan);
    systemRan[0] = &rtAlwaysEnabled;
    systemRan[1] = (sysRanDType *)
      &pwm_with_data_DW.FunctionCallSubsystem_SubsysRan;
    rteiSetModelMappingInfoPtr(pwm_with_data_M->extModeInfo,
      &pwm_with_data_M->SpecialInfo.mappingInfo);
    rteiSetChecksumsPtr(pwm_with_data_M->extModeInfo,
                        pwm_with_data_M->Sizes.checksums);
    rteiSetTPtr(pwm_with_data_M->extModeInfo, rtmGetTPtr(pwm_with_data_M));
  }

  /* block I/O */
  (void) memset(((void *) &pwm_with_data_B), 0,
                sizeof(B_pwm_with_data_T));

  /* states (dwork) */
  (void) memset((void *)&pwm_with_data_DW, 0,
                sizeof(DW_pwm_with_data_T));
  ...
  pwm_with_data_DW.A = pwm_with_data_P.DataStoreMemory_InitialValue;

  /* Start for DataStoreMemory: '<Root>/Data Store Memory1' */
  pwm_with_data_DW.B = pwm_with_data_P.DataStoreMemory1_InitialValue;

  /* Start for DataStoreMemory: '<Root>/Data Store Memory2' */
  pwm_with_data_DW.C = pwm_with_data_P.DataStoreMemory2_InitialValue;

  /* Start for DataStoreMemory: '<Root>/Data Store Memory3' */
  pwm_with_data_DW.D = pwm_with_data_P.DataStoreMemory3_InitialValue;

  /* Start for DataStoreMemory: '<Root>/Data Store Memory4' */
  pwm_with_data_DW.E = pwm_with_data_P.DataStoreMemory4_InitialValue;

  /* Start for DataStoreMemory: '<Root>/Data Store Memory5' */
  pwm_with_data_DW.F = pwm_with_data_P.DataStoreMemory5_InitialValue;
  ...
  /* Start for S-Function (c2802xadc): '<S1>/ADC_VSENB' */
...
void pwm_with_data_terminate(void)
{
