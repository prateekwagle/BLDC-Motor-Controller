...
{
  if (1 == runModel) {
    /* Call the system: <Root>/HALL_U_SUBSYSTEM */
    {
      /* Reset subsysRan breadcrumbs */
      srClearBC(hall_effect_pos_vel_track_en_DW.HALL_U_SUBSYSTEM_SubsysRanBC);

      /* S-Function (c28xisr_c2000): '<Root>/C28x Hardware Interrupt' */

      /* Output and update for function-call system: '<Root>/HALL_U_SUBSYSTEM' */
      {
        real32_T tmp;
        ...
        {
          hall_effect_pos_vel_track_enh_B.DigitalInput_e =
            GpioDataRegs.GPDDAT.bit.GPIO124;
        }

        /* DataStoreWrite: '<S2>/Data Store Write' */
        hall_effect_pos_vel_track_en_DW.HALL_U =
          hall_effect_pos_vel_track_enh_B.DigitalInput_e;
         ...
         *  Sum: '<S2>/Subtract'
         */
        if (hall_effect_pos_vel_track_enh_B.DigitalInput_e -
            hall_effect_pos_vel_track_en_DW.HALL_W ==
            hall_effect_pos_vel_track_enh_P.Constant_Value_o) {
          tmp = hall_effect_pos_vel_track_enh_P.Constant_Value_ej;
        } else {
          tmp = hall_effect_pos_vel_track_enh_P.Constant1_Value_nw;
        }
         ...
         */
        hall_effect_pos_vel_track_enh_B.Add1 =
          hall_effect_pos_vel_track_en_DW.MOT_POS + tmp;
        hall_effect_pos_vel_track_en_DW.HALL_U_SUBSYSTEM_SubsysRanBC = 4;
      }

      /* End of Outputs for S-Function (c28xisr_c2000): '<Root>/C28x Hardware Interrupt' */

      /* RateTransition generated from: '<Root>/HALL_U_SUBSYSTEM' */
      hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_U_SUBSYSTEMOutport[hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_U_SUBSYSTEMOutpo_m
        == 0] = hall_effect_pos_vel_track_enh_B.Add1;
      hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_U_SUBSYSTEMOutpo_i =
        (hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_U_SUBSYSTEMOutpo_m == 0);
    }
...
{
  if (1 == runModel) {
    /* Call the system: <Root>/HALL_W_SUBSYSTEM */
    {
      /* Reset subsysRan breadcrumbs */
      srClearBC(hall_effect_pos_vel_track_en_DW.HALL_W_SUBSYSTEM_SubsysRanBC);

      /* S-Function (c28xisr_c2000): '<Root>/C28x Hardware Interrupt' */

      /* Output and update for function-call system: '<Root>/HALL_W_SUBSYSTEM' */
      ...
      /* S-Function (c280xgpio_di): '<S4>/Digital Input' */
      {
        hall_effect_pos_vel_track_enh_B.DigitalInput_m =
       ...
       *  Sum: '<S4>/Subtract'
       */
      if (hall_effect_pos_vel_track_enh_B.DigitalInput_m -
          hall_effect_pos_vel_track_en_DW.HALL_V ==
          hall_effect_pos_vel_track_enh_P.Constant_Value_o1) {
        /* Switch: '<S4>/Switch1' incorporates:
         *  Constant: '<S4>/Constant'
         */
        hall_effect_pos_vel_track_enh_B.Switch1_o =
         ...
         */
        hall_effect_pos_vel_track_enh_B.Switch1_o =
          hall_effect_pos_vel_track_enh_P.Constant1_Value_p;
      }

      /* End of Switch: '<S4>/Switch1' */
      hall_effect_pos_vel_track_en_DW.HALL_W_SUBSYSTEM_SubsysRanBC = 4;

      /* End of Outputs for S-Function (c28xisr_c2000): '<Root>/C28x Hardware Interrupt' */

      /* RateTransition generated from: '<Root>/HALL_W_SUBSYSTEM' */
      hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_W_SUBSYSTEMOutport[hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_W_SUBSYSTEMOutpo_g
        == 0] = hall_effect_pos_vel_track_enh_B.Switch1_o;
      hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_W_SUBSYSTEMOutpo_d =
        (hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_W_SUBSYSTEMOutpo_g == 0);
    }
...
{
  if (1 == runModel) {
    /* Call the system: <Root>/HALL_V_SUBSYSTEM */
    {
      /* Reset subsysRan breadcrumbs */
      srClearBC(hall_effect_pos_vel_track_en_DW.HALL_V_SUBSYSTEM_SubsysRanBC);

      /* S-Function (c28xisr_c2000): '<Root>/C28x Hardware Interrupt' */

      /* Output and update for function-call system: '<Root>/HALL_V_SUBSYSTEM' */
      ...
      /* S-Function (c280xgpio_di): '<S3>/Digital Input' */
      {
        hall_effect_pos_vel_track_enh_B.DigitalInput =
       ...
       *  Sum: '<S3>/Subtract'
       */
      if (hall_effect_pos_vel_track_enh_B.DigitalInput -
          hall_effect_pos_vel_track_en_DW.HALL_U ==
          hall_effect_pos_vel_track_enh_P.Constant_Value_b) {
        /* Switch: '<S3>/Switch1' incorporates:
         *  Constant: '<S3>/Constant'
         */
        hall_effect_pos_vel_track_enh_B.Switch1 =
          hall_effect_pos_vel_track_enh_P.Constant_Value_es;
      } else {
        /* Switch: '<S3>/Switch1' incorporates:
         *  Constant: '<S3>/Constant1'
         */
        hall_effect_pos_vel_track_enh_B.Switch1 =
          hall_effect_pos_vel_track_enh_P.Constant1_Value_o;
      }

      /* End of Switch: '<S3>/Switch1' */
      hall_effect_pos_vel_track_en_DW.HALL_V_SUBSYSTEM_SubsysRanBC = 4;

      /* End of Outputs for S-Function (c28xisr_c2000): '<Root>/C28x Hardware Interrupt' */

      /* RateTransition generated from: '<Root>/HALL_V_SUBSYSTEM' */
      hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_V_SUBSYSTEMOutport[hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_V_SUBSYSTEMOutpo_e
        == 0] = hall_effect_pos_vel_track_enh_B.Switch1;
      hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_V_SUBSYSTEMOutpo_a =
        (hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_V_SUBSYSTEMOutpo_e == 0);
    }
...
{
  real32_T rtb_TmpRTBAtHALL_U_SUBSYSTEMOut;
  real32_T rtb_TmpRTBAtHALL_V_SUBSYSTEMOut;
  real32_T rtb_TmpRTBAtHALL_W_SUBSYSTEMOut;
  real32_T tmp;

  /* RateTransition generated from: '<Root>/HALL_U_SUBSYSTEM' */
  hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_U_SUBSYSTEMOutpo_m =
    hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_U_SUBSYSTEMOutpo_i;
  rtb_TmpRTBAtHALL_U_SUBSYSTEMOut =
    hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_U_SUBSYSTEMOutport[hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_U_SUBSYSTEMOutpo_m];

  /* RateTransition generated from: '<Root>/HALL_V_SUBSYSTEM' */
  hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_V_SUBSYSTEMOutpo_e =
    hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_V_SUBSYSTEMOutpo_a;
  rtb_TmpRTBAtHALL_V_SUBSYSTEMOut =
    hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_V_SUBSYSTEMOutport[hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_V_SUBSYSTEMOutpo_e];

  /* RateTransition generated from: '<Root>/HALL_W_SUBSYSTEM' */
  hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_W_SUBSYSTEMOutpo_g =
    hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_W_SUBSYSTEMOutpo_d;
  rtb_TmpRTBAtHALL_W_SUBSYSTEMOut =
    hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_W_SUBSYSTEMOutport[hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_W_SUBSYSTEMOutpo_g];

  /* Delay: '<Root>/Delay One Step' */
  hall_effect_pos_vel_track_enh_B.DelayOneStep =
    hall_effect_pos_vel_track_en_DW.DelayOneStep_DSTATE;
   ...
   */
  if ((hall_effect_pos_vel_track_enh_P.IntervalTest_lowlimit <
       hall_effect_pos_vel_track_enh_B.DelayOneStep) &&
      (hall_effect_pos_vel_track_enh_B.DelayOneStep <
       hall_effect_pos_vel_track_enh_P.IntervalTest_uplimit)) {
    tmp = hall_effect_pos_vel_track_enh_B.DelayOneStep;
  } else {
    tmp = hall_effect_pos_vel_track_enh_P.Constant3_Value_m;
  }
   ...
   */
  hall_effect_pos_vel_track_en_DW.DelayOneStep_DSTATE =
    ((rtb_TmpRTBAtHALL_U_SUBSYSTEMOut + rtb_TmpRTBAtHALL_V_SUBSYSTEMOut) +
     rtb_TmpRTBAtHALL_W_SUBSYSTEMOut) + tmp;

  /* DataStoreWrite: '<Root>/Data Store Write3' incorporates:
   *  Delay: '<Root>/Delay One Step'
   */
  hall_effect_pos_vel_track_en_DW.MOT_POS =
    hall_effect_pos_vel_track_en_DW.DelayOneStep_DSTATE;
  ...
  hall_effect_pos_vel_track_en_DW.A =
    hall_effect_pos_vel_track_enh_P.Constant_Value_c1;
  ...
  hall_effect_pos_vel_track_enh_B.DataStoreRead =
    hall_effect_pos_vel_track_en_DW.MOT_POS;

  /* DataStoreRead: '<Root>/Data Store Read1' */
  hall_effect_pos_vel_track_enh_B.DataStoreRead1 =
    hall_effect_pos_vel_track_en_DW.HALL_V;

  /* DataStoreRead: '<Root>/Data Store Read2' */
  hall_effect_pos_vel_track_enh_B.DataStoreRead2 =
    hall_effect_pos_vel_track_en_DW.HALL_U;

  /* DataStoreRead: '<Root>/Data Store Read3' */
  hall_effect_pos_vel_track_enh_B.DataStoreRead3 =
    hall_effect_pos_vel_track_en_DW.HALL_W;
  ...
  hall_effect_pos_vel_track_enh_B.eCAP2_P125_HALL_W[0] = ECap2Regs.CAP1;
  hall_effect_pos_vel_track_enh_B.eCAP2_P125_HALL_W[1] = ECap2Regs.CAP2;

  /* S-Function (c280xcap): '<Root>/eCAP3_P29_HALL_V' */
  hall_effect_pos_vel_track_enh_B.eCAP3_P29_HALL_V[0] = ECap3Regs.CAP1;
  hall_effect_pos_vel_track_enh_B.eCAP3_P29_HALL_V[1] = ECap3Regs.CAP2;

  /* S-Function (c280xcap): '<Root>/eCAP1_P124_HALL_U' */
  hall_effect_pos_vel_track_enh_B.eCAP1_P124_HALL_U[0] = ECap1Regs.CAP1;
  hall_effect_pos_vel_track_enh_B.eCAP1_P124_HALL_U[1] = ECap1Regs.CAP2;
...
void hall_effect_pos_vel_track_enhanced_initialize(void)
{
  ...
  /* External mode info */
  hall_effect_pos_vel_track_en_M->Sizes.checksums[0] = (1841648987U);
  hall_effect_pos_vel_track_en_M->Sizes.checksums[1] = (3127956427U);
  hall_effect_pos_vel_track_en_M->Sizes.checksums[2] = (2728439617U);
  hall_effect_pos_vel_track_en_M->Sizes.checksums[3] = (763972795U);

  {
    ...
    systemRan[2] = (sysRanDType *)
      &hall_effect_pos_vel_track_en_DW.HALL_U_SUBSYSTEM_SubsysRanBC;
    systemRan[3] = (sysRanDType *)
      &hall_effect_pos_vel_track_en_DW.HALL_U_SUBSYSTEM_SubsysRanBC;
    systemRan[4] = (sysRanDType *)
      &hall_effect_pos_vel_track_en_DW.HALL_U_SUBSYSTEM_SubsysRanBC;
    systemRan[5] = (sysRanDType *)
      &hall_effect_pos_vel_track_en_DW.HALL_V_SUBSYSTEM_SubsysRanBC;
    systemRan[6] = (sysRanDType *)
      &hall_effect_pos_vel_track_en_DW.HALL_V_SUBSYSTEM_SubsysRanBC;
    systemRan[7] = (sysRanDType *)
      &hall_effect_pos_vel_track_en_DW.HALL_V_SUBSYSTEM_SubsysRanBC;
    systemRan[8] = (sysRanDType *)
      &hall_effect_pos_vel_track_en_DW.HALL_W_SUBSYSTEM_SubsysRanBC;
  ...
  hall_effect_pos_vel_track_en_DW.HALL_U =
    hall_effect_pos_vel_track_enh_P.DataStoreMemory11_InitialValue;

  /* Start for DataStoreMemory: '<Root>/Data Store Memory12' */
  hall_effect_pos_vel_track_en_DW.HALL_W =
    hall_effect_pos_vel_track_enh_P.DataStoreMemory12_InitialValue;

  /* Start for DataStoreMemory: '<Root>/Data Store Memory13' */
  hall_effect_pos_vel_track_en_DW.MOT_POS =
    hall_effect_pos_vel_track_enh_P.DataStoreMemory13_InitialValue;

  /* Start for DataStoreMemory: '<Root>/Data Store Memory14' */
  hall_effect_pos_vel_track_en_DW.HALL_V =
    hall_effect_pos_vel_track_enh_P.DataStoreMemory14_InitialValue;
  ...
  /* InitializeConditions for RateTransition generated from: '<Root>/HALL_U_SUBSYSTEM' */
  hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_U_SUBSYSTEMOutport[0] =
    hall_effect_pos_vel_track_enh_P.TmpRTBAtHALL_U_SUBSYSTEMOutport;

  /* InitializeConditions for RateTransition generated from: '<Root>/HALL_V_SUBSYSTEM' */
  hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_V_SUBSYSTEMOutport[0] =
    hall_effect_pos_vel_track_enh_P.TmpRTBAtHALL_V_SUBSYSTEMOutport;

  /* InitializeConditions for RateTransition generated from: '<Root>/HALL_W_SUBSYSTEM' */
  hall_effect_pos_vel_track_en_DW.TmpRTBAtHALL_W_SUBSYSTEMOutport[0] =
    hall_effect_pos_vel_track_enh_P.TmpRTBAtHALL_W_SUBSYSTEMOutport;

  /* InitializeConditions for Delay: '<Root>/Delay One Step' */
  hall_effect_pos_vel_track_en_DW.DelayOneStep_DSTATE =
    hall_effect_pos_vel_track_enh_P.DelayOneStep_InitialCondition;
  ...
  /* SystemInitialize for S-Function (c28xisr_c2000): '<Root>/C28x Hardware Interrupt' incorporates:
   *  SubSystem: '<Root>/HALL_U_SUBSYSTEM'
   */
  /* System initialize for function-call system: '<Root>/HALL_U_SUBSYSTEM' */
  ...
  /* SystemInitialize for Sum: '<S2>/Add1' incorporates:
   *  Outport: '<S2>/Outport'
   */
  hall_effect_pos_vel_track_enh_B.Add1 =
  ...
  /* SystemInitialize for S-Function (c28xisr_c2000): '<Root>/C28x Hardware Interrupt' incorporates:
   *  SubSystem: '<Root>/HALL_W_SUBSYSTEM'
   */
  /* System initialize for function-call system: '<Root>/HALL_W_SUBSYSTEM' */
  ...
  /* Start for S-Function (c280xgpio_di): '<S4>/Digital Input' */
  EALLOW;
   ...
   */
  hall_effect_pos_vel_track_enh_B.Switch1_o =
    hall_effect_pos_vel_track_enh_P.Outport_Y0_c;
  ;

  /* SystemInitialize for S-Function (c28xisr_c2000): '<Root>/C28x Hardware Interrupt' incorporates:
   *  SubSystem: '<Root>/HALL_V_SUBSYSTEM'
   */

  /* System initialize for function-call system: '<Root>/HALL_V_SUBSYSTEM' */
  ...
  /* Start for S-Function (c280xgpio_di): '<S3>/Digital Input' */
  EALLOW;
   ...
   */
  hall_effect_pos_vel_track_enh_B.Switch1 =
    hall_effect_pos_vel_track_enh_P.Outport_Y0_d;
  ;
