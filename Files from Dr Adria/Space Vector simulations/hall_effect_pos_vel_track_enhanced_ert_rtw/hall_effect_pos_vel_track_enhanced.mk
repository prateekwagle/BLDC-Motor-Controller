###########################################################################
## Makefile generated for component 'hall_effect_pos_vel_track_enhanced'. 
## 
## Makefile     : hall_effect_pos_vel_track_enhanced.mk
## Generated on : Tue Jul 26 11:57:16 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/hall_effect_pos_vel_track_enhanced.out
...
PRODUCT_NAME              = hall_effect_pos_vel_track_enhanced
MAKEFILE                  = hall_effect_pos_vel_track_enhanced.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/EEEDST~1/DOCUME~1/BLDC-M~1/FILESF~1/SPACEV~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = TI C28x
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/hall_effect_pos_vel_track_enhanced.out
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DXCP_MAX_CTO_SIZE=32 -DXCP_MAX_DTO_SIZE=65532 -DXCP_MAX_ODT_ENTRY_SIZE=255 -DXCP_MAX_DAQ=65535 -DXCP_MIN_DAQ=0 -DXCP_MAX_EVENT_CHANNEL=128 -DXCP_ID_FIELD_TYPE=0 -DXCP_TIMESTAMP_SIZE=4 -DXCP_ADDRESS_GRANULARITY=XCP_ADDRESS_GRANULARITY_WORD -DCODERTARGET_XCP_DAQ_PACKED_MODE -DCODERTARGET_XCP_MAX_CONTIGUOUS_SAMPLES=8 -DXCP_MEM_RESERVED_POOLS_TOTAL_SIZE=802 -DXCP_MEM_DAQ_RESERVED_POOL_BLOCKS_NUMBER=3
...
DEFINES_CUSTOM = 
DEFINES_OPTS = -DXCP_EXTMODE_SIMULATION_TIME_IN_TICKS -DXCP_DAQ_SUPPORT -DXCP_CALIBRATION_SUPPORT -DXCP_TIMESTAMP_SUPPORT -DXCP_TIMESTAMP_BASED_ON_SIMULATION_TIME -DXCP_SET_MTA_SUPPORT -DXCP_MEM_DAQ_RESERVED_POOLS_NUMBER=5 -DEXTMODE_XCP_TRIGGER_SUPPORT -DEXTMODE_STATIC -DEXTMODE_STATIC_SIZE=10000 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=0 -DXCP_MEM_BLOCK_1_SIZE=48 -DXCP_MEM_BLOCK_1_NUMBER=2 -DXCP_MEM_BLOCK_2_SIZE=56 -DXCP_MEM_BLOCK_2_NUMBER=2 -DXCP_MEM_BLOCK_3_SIZE=64 -DXCP_MEM_BLOCK_3_NUMBER=1
...
DEFINES_STANDARD = -DMODEL=hall_effect_pos_vel_track_enhanced -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/hall_effect_pos_vel_track_enhanced_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/hall_effect_pos_vel_track_enhanced_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/hall_effect_pos_vel_track_enhanced_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/hall_effect_pos_vel_track_enhanced_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/hall_effect_pos_vel_track_enhanced_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/hall_effect_pos_vel_track_enhanced_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_xbar.obj : $(START_DIR)/hall_effect_pos_vel_track_enhanced_ert_rtw/MW_c28xx_xbar.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_adc.obj : $(START_DIR)/hall_effect_pos_vel_track_enhanced_ert_rtw/MW_c28xx_adc.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_cap.obj : $(START_DIR)/hall_effect_pos_vel_track_enhanced_ert_rtw/MW_c28xx_cap.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_pwm.obj : $(START_DIR)/hall_effect_pos_vel_track_enhanced_ert_rtw/MW_c28xx_pwm.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/hall_effect_pos_vel_track_enhanced_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


hall_effect_pos_vel_track_enhanced.obj : $(START_DIR)/hall_effect_pos_vel_track_enhanced_ert_rtw/hall_effect_pos_vel_track_enhanced.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


hall_effect_pos_vel_track_enhanced_data.obj : $(START_DIR)/hall_effect_pos_vel_track_enhanced_ert_rtw/hall_effect_pos_vel_track_enhanced_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
