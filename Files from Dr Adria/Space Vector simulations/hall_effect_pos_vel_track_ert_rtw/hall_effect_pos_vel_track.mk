###########################################################################
## Makefile generated for component 'hall_effect_pos_vel_track'. 
## 
## Makefile     : hall_effect_pos_vel_track.mk
## Generated on : Tue Jul 26 14:22:11 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/hall_effect_pos_vel_track.out
...
PRODUCT_NAME              = hall_effect_pos_vel_track
MAKEFILE                  = hall_effect_pos_vel_track.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/hall_effect_pos_vel_track.out
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DXCP_MAX_CTO_SIZE=32 -DXCP_MAX_DTO_SIZE=65532 -DXCP_MAX_ODT_ENTRY_SIZE=255 -DXCP_MAX_DAQ=65535 -DXCP_MIN_DAQ=0 -DXCP_MAX_EVENT_CHANNEL=128 -DXCP_ID_FIELD_TYPE=0 -DXCP_TIMESTAMP_SIZE=4 -DXCP_ADDRESS_GRANULARITY=XCP_ADDRESS_GRANULARITY_WORD -DCODERTARGET_XCP_DAQ_PACKED_MODE -DCODERTARGET_XCP_MAX_CONTIGUOUS_SAMPLES=8 -DXCP_MEM_RESERVED_POOLS_TOTAL_SIZE=289 -DXCP_MEM_DAQ_RESERVED_POOL_BLOCKS_NUMBER=3
...
DEFINES_STANDARD = -DMODEL=hall_effect_pos_vel_track -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/hall_effect_pos_vel_track_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/hall_effect_pos_vel_track_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/hall_effect_pos_vel_track_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/hall_effect_pos_vel_track_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/hall_effect_pos_vel_track_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/hall_effect_pos_vel_track_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_adc.obj : $(START_DIR)/hall_effect_pos_vel_track_ert_rtw/MW_c28xx_adc.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_pwm.obj : $(START_DIR)/hall_effect_pos_vel_track_ert_rtw/MW_c28xx_pwm.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/hall_effect_pos_vel_track_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


hall_effect_pos_vel_track.obj : $(START_DIR)/hall_effect_pos_vel_track_ert_rtw/hall_effect_pos_vel_track.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


hall_effect_pos_vel_track_data.obj : $(START_DIR)/hall_effect_pos_vel_track_ert_rtw/hall_effect_pos_vel_track_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetInf.obj : $(START_DIR)/hall_effect_pos_vel_track_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetNaN.obj : $(START_DIR)/hall_effect_pos_vel_track_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rt_nonfinite.obj : $(START_DIR)/hall_effect_pos_vel_track_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
