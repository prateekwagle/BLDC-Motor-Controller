    ...
    /* Call the system: <Root>/Function-Call Subsystem */
    {
      ...
      /* Output and update for function-call system: '<Root>/Function-Call Subsystem' */
      {
        ...
        if (rtb_Compare &&
          ...
          hall_effect_pos_vel_track_B.Add += fabsf(rtb_Add4);
        ...
        hall_effect_pos_vel_track_B.DataStoreRead5 =
          hall_effect_pos_vel_track_DW.V_PVDD;
...
void hall_effect_pos_vel_track_initialize(void)
{
  ...
  /* External mode info */
  hall_effect_pos_vel_track_M->Sizes.checksums[0] = (1076612390U);
  hall_effect_pos_vel_track_M->Sizes.checksums[1] = (277376188U);
  hall_effect_pos_vel_track_M->Sizes.checksums[2] = (2122634584U);
  hall_effect_pos_vel_track_M->Sizes.checksums[3] = (3846447262U);
