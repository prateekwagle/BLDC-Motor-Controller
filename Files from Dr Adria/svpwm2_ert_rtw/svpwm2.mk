###########################################################################
## Makefile generated for component 'svpwm2'. 
## 
## Makefile     : svpwm2.mk
## Generated on : Thu May 19 16:33:29 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/svpwm2.out
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/svpwm2.out
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/svpwm2_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/tic2000/inc -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/tic2000/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/shared/SUPPOR~1/tic2000/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/shared/SUPPOR~1/tic2000/inc -IC:/ti/CONTRO~1/DEVICE~1/F2837xD/v190/F2837X~1/include -IC:/ti/CONTRO~1/DEVICE~1/F2837xD/v190/F2837X~4/include -IC:/ti/CONTRO~1/DEVICE~1/F2837xD/v190/F2837X~1 -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/shared/EXTERN~1/include -I$(MATLAB_ROOT)/toolbox/rtw/targets/common/can/blocks/tlc_c
...
DEFINES_STANDARD = -DMODEL=svpwm2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/svpwm2_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/svpwm2_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/svpwm2_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/svpwm2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_board.obj : $(START_DIR)/svpwm2_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_csl.obj : $(START_DIR)/svpwm2_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_pwm.obj : $(START_DIR)/svpwm2_ert_rtw/MW_c28xx_pwm.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/svpwm2_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


svpwm2.obj : $(START_DIR)/svpwm2_ert_rtw/svpwm2.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


svpwm2_data.obj : $(START_DIR)/svpwm2_ert_rtw/svpwm2_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
