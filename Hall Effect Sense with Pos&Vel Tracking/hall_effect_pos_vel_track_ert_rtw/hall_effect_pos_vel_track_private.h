 ...
 *
 * File: hall_effect_pos_vel_track_private.h
 *
...
#ifndef RTW_HEADER_hall_effect_pos_vel_track_private_h_
#define RTW_HEADER_hall_effect_pos_vel_track_private_h_
#include "rtwtypes.h"
...
extern void SwitchCaseActionSubsyst_Disable(real32_T *rty_Out1,
  P_SwitchCaseActionSubsystem15_T *localP);
extern void hal_SwitchCaseActionSubsystem15(real32_T *rty_Out1,
  P_SwitchCaseActionSubsystem15_T *localP);
void isr_int1pie1_task_fcn(void);

#endif                     /* RTW_HEADER_hall_effect_pos_vel_track_private_h_ */
