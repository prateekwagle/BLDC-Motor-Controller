...
typedef struct {
  real32_T TmpRTBAtDisplayInport1[2];  /* '<Root>/Triggered Subsystem3' */
  real32_T TmpRTBAtDisplay1Inport1[2]; /* '<Root>/Triggered Subsystem' */
  real32_T TmpRTBAtDisplay2Inport1[2]; /* '<Root>/Triggered Subsystem1' */
  real32_T eCAP3_P29_HALL_V_o1[2];     /* '<Root>/eCAP3_P29_HALL_V' */
  real32_T eCAP2_P125_HALL_W_o1[2];    /* '<Root>/eCAP2_P125_HALL_W' */
  real32_T eCAP1_P124_HALL_U_o1[2];    /* '<Root>/eCAP1_P124_HALL_U' */
  real32_T RT2[2];                     /* '<Root>/RT2' */
  real32_T RT1[2];                     /* '<Root>/RT1' */
  real32_T RT_a[2];                    /* '<Root>/RT' */
  real32_T TmpLatchAtIn1Outport1[2];   /* '<S3>/TmpLatchAtIn1Outport1' */
  real32_T TmpLatchAtIn1Outport1_k[2]; /* '<S4>/TmpLatchAtIn1Outport1' */
  real32_T TmpLatchAtIn1Outport1_ki[2];/* '<S2>/TmpLatchAtIn1Outport1' */
  real32_T Product;                    /* '<S16>/Product' */
  real32_T Product_d;                  /* '<S12>/Product' */
  real32_T Product_p;                  /* '<S13>/Product' */
  real32_T Product_o;                  /* '<S14>/Product' */
  real32_T Divide;                     /* '<S10>/Divide' */
  real32_T Divide_b;                   /* '<S8>/Divide' */
  real32_T Divide_d;                   /* '<S9>/Divide' */
  ...
  boolean_T eCAP3_P29_HALL_V_o2[2];    /* '<Root>/eCAP3_P29_HALL_V' */
  boolean_T eCAP2_P125_HALL_W_o2[2];   /* '<Root>/eCAP2_P125_HALL_W' */
  boolean_T eCAP1_P124_HALL_U_o2[2];   /* '<Root>/eCAP1_P124_HALL_U' */
...
typedef struct {
  ...
  volatile real32_T TmpRTBAtDisplayInport1_Buffer[4];/* synthesized block */
  volatile real32_T TmpRTBAtDisplay1Inport1_Buffer[4];/* synthesized block */
  volatile real32_T TmpRTBAtDisplay2Inport1_Buffer[4];/* synthesized block */
  volatile real32_T RT_Buffer[4];      /* '<Root>/RT' */
  ...
  volatile int16_T TmpRTBAtDisplayInport1_ActiveBu;/* synthesized block */
  volatile int16_T TmpRTBAtDisplayInport1_semaphor;/* synthesized block */
  volatile int16_T TmpRTBAtDisplay1Inport1_ActiveB;/* synthesized block */
  volatile int16_T TmpRTBAtDisplay1Inport1_semapho;/* synthesized block */
  volatile int16_T TmpRTBAtDisplay2Inport1_ActiveB;/* synthesized block */
  volatile int16_T TmpRTBAtDisplay2Inport1_semapho;/* synthesized block */
  ...
  int16_T TriggeredSubsystem1_SubsysRanBC;/* '<Root>/Triggered Subsystem1' */
  int16_T TriggeredSubsystem3_SubsysRanBC;/* '<Root>/Triggered Subsystem3' */
  int16_T TriggeredSubsystem_SubsysRanBC;/* '<Root>/Triggered Subsystem' */
...
struct P_hall_effect_pos_vel_track_e_T_ {
  ...
  real32_T Outport_Y0;                 /* Computed Parameter: Outport_Y0
                                        ...
                                        */
  real32_T Outport_Y0_o;               /* Computed Parameter: Outport_Y0_o
                                        * Referenced by: '<S4>/Outport'
                                        */
  real32_T Outport_Y0_i;               /* Computed Parameter: Outport_Y0_i
  ...
  real32_T DataStoreMemory13_InitialValue;
                            ...
                            */
  real32_T TmpRTBAtDisplayInport1_InitialC;
                          /* Computed Parameter: TmpRTBAtDisplayInport1_InitialC
                           * Referenced by:
                           */
  real32_T TmpRTBAtDisplay1Inport1_Initial;
                          /* Computed Parameter: TmpRTBAtDisplay1Inport1_Initial
                           * Referenced by:
                           */
  real32_T TmpRTBAtDisplay2Inport1_Initial;
  ...
  real32_T RT1_InitialCondition;     /* Computed Parameter: RT1_InitialCondition
                                      ...
                                      */
  real32_T RT2_InitialCondition;     /* Computed Parameter: RT2_InitialCondition
 ...
 * '<S2>'   : 'hall_effect_pos_vel_track_enhanced/Triggered Subsystem'
 * '<S3>'   : 'hall_effect_pos_vel_track_enhanced/Triggered Subsystem1'
 * '<S4>'   : 'hall_effect_pos_vel_track_enhanced/Triggered Subsystem3'
 * '<S5>'   : 'hall_effect_pos_vel_track_enhanced/Function-Call Subsystem/Subsystem'
 * '<S6>'   : 'hall_effect_pos_vel_track_enhanced/Function-Call Subsystem/Subsystem1'
 * '<S7>'   : 'hall_effect_pos_vel_track_enhanced/Function-Call Subsystem/Subsystem10'
 * '<S8>'   : 'hall_effect_pos_vel_track_enhanced/Function-Call Subsystem/Subsystem11'
 * '<S9>'   : 'hall_effect_pos_vel_track_enhanced/Function-Call Subsystem/Subsystem12'
 * '<S10>'  : 'hall_effect_pos_vel_track_enhanced/Function-Call Subsystem/Subsystem13'
 * '<S11>'  : 'hall_effect_pos_vel_track_enhanced/Function-Call Subsystem/Subsystem2'
 * '<S12>'  : 'hall_effect_pos_vel_track_enhanced/Function-Call Subsystem/Subsystem3'
 * '<S13>'  : 'hall_effect_pos_vel_track_enhanced/Function-Call Subsystem/Subsystem4'
 * '<S14>'  : 'hall_effect_pos_vel_track_enhanced/Function-Call Subsystem/Subsystem5'
 * '<S15>'  : 'hall_effect_pos_vel_track_enhanced/Function-Call Subsystem/Subsystem6'
 * '<S16>'  : 'hall_effect_pos_vel_track_enhanced/Function-Call Subsystem/Subsystem7'
 * '<S17>'  : 'hall_effect_pos_vel_track_enhanced/Function-Call Subsystem/Subsystem8'
 * '<S18>'  : 'hall_effect_pos_vel_track_enhanced/Function-Call Subsystem/Subsystem9'
 */
