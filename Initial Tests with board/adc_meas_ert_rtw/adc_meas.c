...
void adc_meas_step(void)
{
  /* S-Function (c2802xadc): '<Root>/ADC' */
  {
    ...
    adc_meas_B.ADC = (AdcaResultRegs.ADCRESULT0);
  }
...
void adc_meas_initialize(void)
{
  ...
  /* External mode info */
  adc_meas_M->Sizes.checksums[0] = (3148319152U);
  adc_meas_M->Sizes.checksums[1] = (2352609856U);
  adc_meas_M->Sizes.checksums[2] = (404289016U);
  adc_meas_M->Sizes.checksums[3] = (890450408U);
