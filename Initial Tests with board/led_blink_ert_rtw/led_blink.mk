...
## Generated on : Mon Jul 04 21:53:53 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/led_blink.out
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/led_blink.out
...
OBJS = MW_c28xx_csl.obj MW_c28xx_board.obj led_blink.obj led_blink_data.obj sysctl.obj c2837xDBoard_Realtime_Support.obj MW_c28xGlobalInterrupts.obj dma.obj F2837xD_CpuTimers.obj F2837xD_DefaultISR.obj F2837xD_GlobalVariableDefs.obj F2837xD_PieCtrl.obj F2837xD_PieVect.obj F2837xD_SysCtrl.obj F2837xD_usDelay.obj F2837xD_CodeStartBranch.obj F2837xD_Dma.obj F2837xD_Adc.obj F2837xD_Gpio.obj F2837xD_Ipc_Driver_Lite.obj c2000HardwareTimerConfig.obj MW_c28xGPIO.obj c2837xDSchedulerTimer0.obj
...
%.obj : $(START_DIR)/led_blink_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/led_blink_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/led_blink_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/led_blink_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/led_blink_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/led_blink_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/led_blink_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
...
led_blink_data.obj : $(START_DIR)/led_blink_ert_rtw/led_blink_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
