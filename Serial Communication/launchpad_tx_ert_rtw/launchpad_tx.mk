###########################################################################
## Makefile generated for component 'launchpad_tx'. 
## 
## Makefile     : launchpad_tx.mk
## Generated on : Fri Jul 08 13:53:43 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/launchpad_tx.out
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/launchpad_tx.out
...
DEFINES_STANDARD = -DMODEL=launchpad_tx -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/launchpad_tx_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/launchpad_tx_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/launchpad_tx_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/launchpad_tx_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/launchpad_tx_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/launchpad_tx_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


DSP28xx_SciUtil.obj : $(START_DIR)/launchpad_tx_ert_rtw/DSP28xx_SciUtil.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/launchpad_tx_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


launchpad_tx.obj : $(START_DIR)/launchpad_tx_ert_rtw/launchpad_tx.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


launchpad_tx_data.obj : $(START_DIR)/launchpad_tx_ert_rtw/launchpad_tx_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
