###########################################################################
## Makefile generated for component 'adc_meas_plus_serial'. 
## 
## Makefile     : adc_meas_plus_serial.mk
## Generated on : Fri Jul 08 14:38:31 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/adc_meas_plus_serial.out
...
PRODUCT_NAME              = adc_meas_plus_serial
MAKEFILE                  = adc_meas_plus_serial.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/adc_meas_plus_serial.out
...
DEFINES_STANDARD = -DMODEL=adc_meas_plus_serial -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/adc_meas_plus_serial_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/adc_meas_plus_serial_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/adc_meas_plus_serial_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/adc_meas_plus_serial_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/adc_meas_plus_serial_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/adc_meas_plus_serial_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


DSP28xx_SciUtil.obj : $(START_DIR)/adc_meas_plus_serial_ert_rtw/DSP28xx_SciUtil.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_adc.obj : $(START_DIR)/adc_meas_plus_serial_ert_rtw/MW_c28xx_adc.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


adc_meas_plus_serial.obj : $(START_DIR)/adc_meas_plus_serial_ert_rtw/adc_meas_plus_serial.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/adc_meas_plus_serial_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
